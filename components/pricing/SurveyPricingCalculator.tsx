...
export default function SurveyPricingCalculator() {
  ...
  return <div className="grid gap-8 rounded-[28px] border border-gray-200 bg-white p-6 shadow-sm md:grid-cols-2 sm:p-8">
    <div className="space-y-5">
      ...
      <label className="flex items-center gap-3 text-sm"><input type="checkbox" checked={input.includeDetailedReport} onChange={e => setInput({ ...input, includeDetailedReport: e.target.checked })} />Detailed AI report: +$20 once per survey</label>
