...
function mapProfile(
  ...
  return {
    ...
    employmentStatus: communityRow?.employment_status ?? getStringValue(metadata.employment_status),
    industry: communityRow?.industry ?? getStringValue(metadata.industry),
    ...
    fieldOfStudy: communityRow?.field_of_study ?? getStringValue(metadata.field_of_study),
    languageSkills: communityRow?.language_skills ?? getStringArray(metadata.language_skills),
    englishProficiency:
      communityRow?.english_proficiency ?? getStringValue(metadata.english_proficiency),
    ...
    householdSize: communityRow?.household_size ?? getStringValue(metadata.household_size),
    childrenCount: communityRow?.children_count ?? getStringValue(metadata.children_count),
